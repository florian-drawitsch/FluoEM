function nodesRefNeighbors = ellipsoidNhood( skelRef, skelRefTreeIdx, skelTar, skelTarTreeInds, ellipsoidRadii )
%ELLIPSOIDNHOOD computes the skeleton neighbors contained in an   
