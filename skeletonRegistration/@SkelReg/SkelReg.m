...
%   INPUT:  fpathEM (optional): str
%               Full path to webKnossos skeleton (.nml) file containing EM
%               annotations (registration reference). File selection dialog
%               box is opened when not provided.
%           fpathLM (optional): str
%               Full path to webKnossos skeleton (.nml) file containing
%               LM annotations (registration target). File selection
%               dialog box is opened when not provided.             
